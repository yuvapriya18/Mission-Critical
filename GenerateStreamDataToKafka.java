...
public class GenerateStreamDataToKafka {
    private static final Gson gson = new Gson();
    private static final Random random = new Random();

    // Kafka topic
    private static final String TOPIC = "bigstream";
    ...
    public static void main(String[] args) throws InterruptedException {
        while (true) {
            ...
            for (int i = 0; i <= recordsCount; i++) {
                ...
                String jsonData = gson.toJson(spacecraftData);
                TestKafkaProducer.sendDataToKafka(TOPIC, jsonData, spacecraftData.getSpacecraftId());

            }

            System.out.println("Written " + recordsCount + " records to Kafka.");
            Thread.sleep(1000);
        }
    }
